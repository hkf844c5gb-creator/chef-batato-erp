...
export default function GestaoCardapioUnificada() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
        ...
        <div className="px-6 py-4">
          <div className="mb-3">
            <h1 className="text-xl font-black text-orange-500">
              🍽️ Chef Batatô · Gestão do Cardápio
            </h1>
            <p className="mt-1 text-xs text-zinc-400">
              Produtos e combos no mesmo lugar.
            </p>
          </div>
      ...
      {abaAtiva === 'produtos' ? <ProdutosTab /> : <CombosTab />}
    </div>
  );
}
