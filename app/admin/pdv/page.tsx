      ...
      <head>
        ...
        <style>
          ...
          * { box-sizing: border-box; }
          ...
          .titulo { font-size: 26px; font-weight: 900; margin-bottom: 3px; }
          .pedido { font-size: 30px; font-weight: 900; margin: 6px 0; line-height: 1; }
          .linha { border-top: 2px dashed #000; margin: 8px 0; }
          .dados { margin: 3px 0; word-break: break-word; font-size: 14px; font-weight: 800; }
          .item { margin: 8px 0; page-break-inside: avoid; }
          .item-nome { font-weight: 900; font-size: 16px; line-height: 1.2; word-break: break-word; }
          .item-valores { display: flex; justify-content: space-between; gap: 5px; font-size: 14px; font-weight: 800; margin-top: 2px; }
          .item-valores strong { font-weight: 900; }
          .total-linha { display: flex; justify-content: space-between; gap: 5px; font-size: 15px; font-weight: 800; margin: 3px 0; }
          .total-geral { font-size: 24px; font-weight: 900; margin-top: 7px; }
          .rodape { margin-top: 10px; text-align: center; font-size: 13px; font-weight: 800; }
