      ...
      if (pedidoGravado) {
        ...
        if (imprimirAtivado) {
          const dadosRecibo = {
            ...
            contacto_cliente: contactoCliente.trim(),
            endereco: moradaCliente.trim(),
            // IMPORTANTE: usa a mesma propriedade da página de Pedidos.
            // O motor ESC/POS recebe "itens" e aplica exatamente o mesmo
            // formato de impressão usado quando reimprimimos em /admin/pedidos.
