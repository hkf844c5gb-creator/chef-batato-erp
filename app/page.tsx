...
export default function CaixaPDV() {
  ...
  const finalizarVenda = async () => {
    ...
    try {
      ...
      // 2. Registar os Itens da Venda (se tiver a tabela itens_venda criada)
      if (venda) {
        ...
        // Se der erro nos itens mas a venda foi criada, avisamos (ou pode ignorar se não tiver a tabela de itens ainda)
      ...
      // Fallback amigável caso não tenha as tabelas de vendas criadas ainda
    ...
    <div className="min-h-screen bg-zinc-950 text-white flex flex-col">
      <header className="bg-zinc-900 border-b border-zinc-800 px-6 py-4 flex justify-between items-center">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold text-orange-500 tracking-wide">Chef Batatô & BrownieRia</h1>
        </div>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <main className="flex-1 p-6 overflow-y-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 content-start">
          <div className="col-span-full border-b border-zinc-800 pb-2 mb-2">
            <h2 className="text-lg font-semibold text-zinc-300">Menu de Vendas (Dados do Supabase)</h2>
          </div>
